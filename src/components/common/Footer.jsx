...
function Footer() {
    ...
    return (
        <>
            ...
            {/* Ad below footer - cleaner separation */}
            <div className="footer-ad-container bg-dark bg-opacity-95 pb-4">
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <hr className="border-secondary opacity-25 mb-3" />
                            <small className="text-muted d-block text-center mb-2">Advertisement</small>
                            <GoogleAds />
                        </div>
                    </div>
                </div>
